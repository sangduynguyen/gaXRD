...
#DA2 = kz * lamda / E_IR
DA2 = kz * lamda / (np.exp(b_IR))
#DA2 = kz * lamda / b_IR
#Di2 = kz * abs(lamda / (FWHM2 * costheta2))
print("DA_LR_MS=", DA2, " nm")
...
bx.set_xlabel('ln(1/cos$θ$$)', fontsize=15)
bx.set_ylabel('ln$β$', fontsize=15)
    #bx.plot(x_ND, y_ln, 'r-')
...
bx.text(0.1, 0.65, r'DA_VGL_MS = {0:0.6f} nm'
...
ax1.text(0.01, 0.995, r'Volgt model'+', FOM = {0:0.6f}'
         .format(abs(FOM(cnsts, y, x, n_value)))+', DA_VGL_PS = {0:0.6f} nm\n'
